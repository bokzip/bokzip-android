...
import com.unionz.bokzip.databinding.ItemCategoryBtnBinding
...
class FilterItemAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        return if (type == FilterOption.CATEGORY) {
            val binding =
                ItemCategoryBtnBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CategoryViewHolder(val binding: ItemCategoryBtnBinding) :
    ...
    inner class LocationViewHolder(val binding: ItemLocationBtnBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int) {
            with(binding) {
